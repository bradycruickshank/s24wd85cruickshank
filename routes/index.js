...
res.render('index', { title: 'Ostrich App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'Ostrich App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Ostrich App Login', user : req.user });
  });
